...
import com.example.parts_sales_system.ui.financial_management.HomeFragment;
...
public class public_FinancialManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_public_financial_management);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.MainActivity:
                Intent intent=new Intent(public_FinancialManagementActivity.this,public_MainActivity.class);
