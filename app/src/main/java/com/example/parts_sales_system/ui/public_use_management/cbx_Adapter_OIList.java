...
public class cbx_Adapter_OIList extends BaseAdapter{
    ...
    public cbx_Adapter_OIList(List<HashMap<String, Object>> data_data, List<Model_check> data, Context context, RequirementManagement.AllCheckListener allCheckListener) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ViewHoder hd;
        if (view == null) {
            hd = new cbx_Adapter_OIList.ViewHoder();
        ...
        hd = (cbx_Adapter_OIList.ViewHoder) view.getTag();
        ...
        final cbx_Adapter_OIList.ViewHoder hdFinal = hd;
