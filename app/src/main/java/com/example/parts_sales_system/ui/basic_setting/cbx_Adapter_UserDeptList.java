...
public class cbx_Adapter_UserDeptList extends BaseAdapter {
    ...
    //最后一个字符串命名要改
    private String creator,creatime,updater,updatetime,UserDeptCodeID;
    public static List index;
    public cbx_Adapter_UserDeptList(List<HashMap<String, Object>> data_data, List<Model_check> data, Context context, ProductData.AllCheckListener allCheckListener) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            //对应的布局文件要改
            view = layoutInflater.inflate(R.layout.public_basic_setting_usermanagement_userdeptlist_item_cbx, null);
            ...
            hd.ID= view.findViewById(R.id.UserDeptCodeID);
        ...
        UserDeptCodeID=String.valueOf(data_data.get(i).get("UserDeptCodeID"));
        hd.ID.setText(UserDeptCodeID);
