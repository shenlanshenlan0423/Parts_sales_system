...
public class cbx_Adapter_UseAlertList extends BaseAdapter {
    ...
    //最后一个字符串命名要改
    private String creator,creatime,updater,updatetime,BuildRecordCodeID;
    public static List index;
    public cbx_Adapter_UseAlertList(List<HashMap<String, Object>> data_data, List<Model_check> data, Context context, FeedBackManagement.AllCheckListener allCheckListener) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            hd.ID= view.findViewById(R.id.BuildRecordCodeID);
        ...
        BuildRecordCodeID=String.valueOf(data_data.get(i).get("ID"));
        hd.ID.setText(BuildRecordCodeID);
